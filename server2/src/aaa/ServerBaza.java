...
public class ServerBaza {
	...
	// envContext).lookup("jdbc/jdbcConect");
	...
	String rejestracja(String imie, String nazwisko, String PESEL, String numerTel, String miejscowosc,
		 ...
		 * System.err.println("baza3"); String sql; Statement stm = (Statement)
		 * connect.createStatement(); sql =
		 * "INSERT INTO samochod (VIN, Marka, Model, Rok_Produkcji, Paliwo, Pojemnosc, Moc_Silnika, Kraj_Pochodzenia, Przebieg, KlientPESEL)"
		 * + "VALUE ('" +msg.tabStrin[0] +"', '"+msg.tabStrin[1]+"', '" +
		 * msg.tabStrin[2] + "', '"+ msg.tabStrin[3] + "', '" + msg.tabStrin[4]
		 * +"'," + msg.tabStrin[5]+ "," + msg.tabStrin[6] +", '" +
		 * msg.tabStrin[7] + "'," + msg.tabStrin[8] + "," + msg.tabStrin[9]
		 * +");"; stm.executeUpdate(sql); return true; }
	...
	public static String getNumerTelefonu() throws SQLException {
		...
		// ResultSet result = stm.executeQuery(sql);
		// while(result.next()){
		// wynik += result.getString("Nr_telefonu");
		// }
		// System.err.println(wynik);
		// return wynik;
