...
public class Strona {
	...
	public static String historia() {
		...
		out.append("<input type=\"text\" class =\"tekst\"  id=\"haslo\"><br />\n");
	...
	public static String serwisant() {
		...
		out.append(
				"<a href=\"ASO?strona=dodprac\"><button type=\"button\" class=\"button\" >Dodaj nowego pracownika</button></a><br><br>\n");
		out.append(
		...
		// out.append(
		// "<div id =\"content\" style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"> </div>\n");
		...
		// type=\"type/html\"data=\"ASO?strona=tSerwis\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		// out.append("}\n");
		//
		// out.append("function load_home1() {\n");
		// out.append(
		// "document.getElementById(\"content\").innerHTML='<object
		// type=\"type/html\"data=\"ASO?strona=dodprac\"id=\"dupa\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		// out.append("}\n");
		//
		...
		// out.append(
		// "document.getElementById(\"content\").innerHTML='<object
		// type=\"type/html\"data=\"ASO?strona=cVIN\"id=\"dupa1\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		// out.append("}\n");
		//
		...
		// out.append(
		// "document.getElementById(\"content\").innerHTML='<object
		// type=\"type/html\"data=\"ASO?strona=addwizy\"id=\"dupa2\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		//
		// out.append("}\n");
		//
		...
		// out.append(
		// "document.getElementById(\"content\").innerHTML='<object
		// type=\"type/html\"data=\"ASO?strona=napraw\"id=\"dupa3\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		//
		// out.append("}\n");
		// out.append("function load_home5() {\n");
		// out.append(
		// "document.getElementById(\"content\").innerHTML='<object
		// type=\"type/html\"data=\"ASO?strona=bramka\"id=\"dupa4\"style=\"width:800px;height:800px;border:0px
		// solid;resize:none;overflow:auto;\"></object>';\n");
		//
		// out.append("}\n");
	...
	public static String uWizyta() {
		...
		out.append(
				"<p>Podaj date<br> <br><input type=\"text\"  class =\"tekst\" id=\"datepicker\" autofocus=\"0\"></p>\n");
		out.append("Nazwa serwisu<br>\n");
		out.append("<input type=\"text\" class =\"tekst\"  id=\"nazwa\"><br><br>\n");
		out.append("Model samochodu<br>\n");
		out.append("<input type=\"text\" class =\"tekst\"  id=\"model\"><br><br>\n");
	...
	public static String napraw() {
		...
		out.append("<input type=\"text\"  class =\"tekst\" id=\"id\" value=\"\"><br><br>\n");
		out.append("Typ naprawy<br>\n");
		out.append("<input type=\"text\"  class =\"tekst\" id=\"typ\" value=\"\"><br><br>\n");
		out.append("Koszt<br>\n");
		out.append("<input type=\"text\" class =\"tekst\"  id=\"koszt\" value=\"\"><br>\n");
		out.append("<button  class =\"button\" onclick=\"myFunction()\">Wyœwietl samochody do naprawy</button>\n");
		out.append("<br /><button class =\"button\"  onclick=\"myFunction2()\">Napraw</button>\n");
		// out.append("<div id =\"content\"> </div>\n");
		out.append("</font>\n");
		out.append("</center>\n");
